...
{
	/// <summary>
	/// Database Access Layer for Hospital Management System
	/// CLOUD READINESS IMPROVEMENTS:
	/// - Uses connection pooling (automatic with SqlConnection)
	/// - Implements proper using statements for resource disposal
	/// - Connection string supports Azure SQL Database
	/// - Prepared for migration to Entity Framework Core
	/// </summary>
	public class myDAL
    {
		/// <summary>
		/// Connection string retrieved from configuration
		/// CLOUD DEPLOYMENT: Override via Azure App Service Application Settings
		/// Environment variable: SQLAZURECONNSTR_sqlCon1
		/// </summary>
        private static readonly string connString =
            System.Configuration.ConfigurationManager.ConnectionStrings["sqlCon1"].ConnectionString;

		// Connection timeout for cloud resilience (30 seconds default for Azure SQL)
		private const int CommandTimeout = 30;

		/// <summary>
		/// Helper method to create and open a SQL connection with proper error handling
		/// </summary>
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("Login", con))
					{
						...
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					// Log error for cloud monitoring
					System.Diagnostics.Trace.TraceError($"Login validation error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public int validateUser (string Name, string BirthDate, string Email , string Password , string PhoneNo , string gender , string Address, ref int id)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("PatientSignup", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"User validation error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public int DoctorEmailAlreadyExist(string Email)
        {
            using (SqlConnection con = CreateConnection())
            {
				...
				{
					System.Diagnostics.Trace.TraceError($"Doctor email check error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public void AddDoctor(string Name, string Email, string Password, string BirthDate, int dept, string Phone, char gender, string Address, int exp, int salary, int Charges_per_visit, string spec, string qual)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("AddDoctor", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Add doctor error: {ex.Message}");
					throw;
				}
			}
        }
        ...
        public int AddStaff(string Name, string BirthDate, string Phone, char gender, string Address, int salary, string Qual, string Designation)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("AddStaff", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Add staff error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public void GetAdminHomeInformation(ref DataTable[] arrTable)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("SELECT * FROM Total_Patient", con))
					{
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get admin home info error: {ex.Message}");
					throw;
				}
			}
        }
        ...
        public int DeleteDoctor(int id)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("DeleteDoctor", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Delete doctor error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public int DeleteStaff(int id)
        {
            using (SqlConnection con = CreateConnection())
            {
				...
				{
					System.Diagnostics.Trace.TraceError($"Delete staff error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public void LoadDoctor(ref DataTable table, String SearchQuery)
        {
            using (SqlConnection con = CreateConnection())
            {
				...
				{
					System.Diagnostics.Trace.TraceError($"Load doctor error: {ex.Message}");
					throw;
				}
			}
        }
        ...
        public void LoadPatient(ref DataTable table, String SearchQuery)
        {
            using (SqlConnection con = CreateConnection())
            {
				...
				{
					System.Diagnostics.Trace.TraceError($"Load patient error: {ex.Message}");
					throw;
				}
			}
        }
        ...
        public void LoadOtherStaff(ref DataTable table, String SearchQuery)
        {
            using (SqlConnection con = CreateConnection())
            {
				...
				{
					System.Diagnostics.Trace.TraceError($"Load staff error: {ex.Message}");
					throw;
				}
			}
        }
        ...
        public int GETPATIENT(int pid, ref string name, ref string phone, ref string address, ref string birthDate, ref int age, ref string gender)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrievePatientData", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get patient error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public int GET_DOCTOR_PROFILE(int dID, ref string name, ref string phone, ref string gender, ref float charges_Per_Visit, ref float ReputeIndex, ref int PatientsTreated, ref string qualification, ref string specialization, ref int workE, ref int age)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("GET_DOCTOR_PROFILE", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get doctor profile error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public int GETSATFF(int id, ref string name, ref string phone, ref string address, ref string gender, ref string desig, ref int sal)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("GET_STAFF", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get staff error: {ex.Message}");
					return -1;
				}
			}
        }
        ...
        public int patientInfoDisplayer(int pid, ref string name, ref string phone, ref string address, ref string birthDate, ref int age, ref string gender)
		{
            using (SqlConnection con = CreateConnection())
            {
				...
				{
					System.Diagnostics.Trace.TraceError($"Patient info display error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int getBillHistory(int id, ref DataTable result)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrieveBillHistory", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get bill history error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int appointmentTodayDisplayer(int pid, ref string dName, ref string timings)
		{
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrieveCurrentAppointment", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Appointment today display error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int getTreatmentHistory(int id, ref DataTable result)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrieveTreatmentHistory", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get treatment history error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int getdeptInfo(ref DataTable result)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("select* from deptInfo", con))
					{
				...
				{
					System.Diagnostics.Trace.TraceError($"Get dept info error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int getDeptDoctorInfo(string deptName, ref DataTable result)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrieveDeptDoctorInfo", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get dept doctor info error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int doctorInfoDisplayer(int dID, ref string name, ref string phone, ref string gender, ref float charges_Per_Visit, ref float ReputeIndex, ref int PatientsTreated, ref string qualification, ref string specialization, ref int workE, ref int age)
		{
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrieveDoctorData", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Doctor info display error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int getFreeSlots(int dID, int pID, ref DataTable result)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrieveFreeSlots", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get free slots error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int insertAppointment(int dID, int pID, int freeSlot, ref string mes)
		{
            using (SqlConnection con = CreateConnection())
            {
				...
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("insertInAppointmentTable", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Insert appointment error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int getNotifications(int pid, ref string dName, ref string timings)
		{
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrievePatientNotifications", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get notifications error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int isFeedbackPending(int pid, ref string dName, ref string timings, ref int aID)
		{
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrievePendingFeedback", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Is feedback pending error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int givePendingFeedback(int aID)
		{
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("storeFeedback", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Give pending feedback error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int docinfo_DAL(int doctorid, ref DataTable result)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("Doctor_Information_By_ID1", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Doc info error: {ex.Message}");
					return 0;
				}
			}
		}
		...
		public void GetAllpendingappointments_DAL(int doctorid, ref DataTable DT)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("PENDING_APPOINTMENTS2", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get pending appointments error: {ex.Message}");
				}
			}
		}
		...
		public int UpdateAppointment_DAL(int Appointmentid)
		{
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("APPROVE_APPOINTMENT", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Update appointment error: {ex.Message}");
					return 0;
				}
			}
		}
		...
		public int Deleteappointment_DAL(int appointmentid)
		{
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("delete_APPOINTMENT", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Delete appointment error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int search_patient_DAL(int did, ref DataTable result)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("TODAYS_APPOINTMENTS", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Search patient error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public int update_prescription_DAL(int did, int appointid, string disease, string progres, string prescrip)
		{
            using (SqlConnection con = CreateConnection())
            {
				...
				{
					System.Diagnostics.Trace.TraceError($"Update prescription error: {ex.Message}");
					return 0;
				}
			}
		}
		...
		public int generate_bill_DAL(int docid, ref DataTable result)
		{
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("generate_bill", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Generate bill error: {ex.Message}");
					return -1;
				}
			}
		}
		...
		public void paid_bill_DAL(int did, int appoint)
		{
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("finishedPaid", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Paid bill error: {ex.Message}");
				}
			}
		}
        ...
        public void Unpaid_bill_DAL(int did, int appoint)
        {
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd = new SqlCommand("finishedUnPaid", con))
					{
						cmd.CommandType = CommandType.StoredProcedure;
						cmd.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Unpaid bill error: {ex.Message}");
				}
			}
        }
        ...
        public int getPHistory(int id, ref DataTable result)
        {
            ...
            using (SqlConnection con = CreateConnection())
            {
				try
				{
					using (SqlCommand cmd1 = new SqlCommand("RetrievePHistory", con))
					{
						cmd1.CommandType = CommandType.StoredProcedure;
						cmd1.CommandTimeout = CommandTimeout;
				...
				{
					System.Diagnostics.Trace.TraceError($"Get patient history error: {ex.Message}");
					return -1;
				}
			}
        }
